var seedProducts = [
  ...
  { name: "Acqua di Gio", brand: "Giorgio Armani", category: "رجالي", image: "https://images.unsplash.com/photo-1590736969955-71cc94901144?w=400&h=400&fit=crop", sizes: [{size: "100ml", price: 250},{size: "75ml", price: 190}], status: "", description: "أكوا دي جيو - انتعاش البحر المتوسط" },
  ...
  { name: "Burberry Her", brand: "Burberry", category: "نسائي", image: "https://images.unsplash.com/photo-1595425964272-fc617fa25e92?w=400&h=400&fit=crop", sizes: [{size: "100ml", price: 240},{size: "50ml", price: 170}], status: "", description: "بربري هير - أنوثة لندنية عصرية" },
  ...
  { name: "Aventus", brand: "Creed", category: "رجالي", image: "https://images.unsplash.com/photo-1600612253971-422b1a37aab0?w=400&h=400&fit=crop", sizes: [{size: "100ml", price: 500},{size: "50ml", price: 320}], status: "special", description: "أفينتوس كريد - عطر النجاح والثروة" },
  { name: "Miss Dior", brand: "Dior", category: "نسائي", image: "https://images.unsplash.com/photo-1588514912908-8c1a5246e0d8?w=400&h=400&fit=crop", sizes: [{size: "100ml", price: 290},{size: "50ml", price: 200}], status: "new", description: "ميس ديور - رومانسية الورد الباريسي" },
  ...
  { name: "Mercedes Benz", brand: "Mercedes", category: "رجالي", image: "https://images.unsplash.com/photo-1595535373192-fc8935baec22?w=400&h=400&fit=crop", sizes: [{size: "120ml", price: 180},{size: "75ml", price: 130}], status: "", description: "مرسيدس بنز - أناقة السيارة في عطر" },
  { name: "Narciso Rodriguez", brand: "Narciso", category: "نسائي", image: "https://images.unsplash.com/photo-1605651531144-51381895e23a?w=400&h=400&fit=crop", sizes: [{size: "90ml", price: 260},{size: "50ml", price: 180}], status: "new", description: "نارسيسو رودريغز - مسك ناعم وحسي" },
  { name: "1 Million", brand: "Paco Rabanne", category: "رجالي", image: "https://images.unsplash.com/photo-1619994403073-2cec844b8c63?w=400&h=400&fit=crop", sizes: [{size: "100ml", price: 230},{size: "50ml", price: 160}], status: "bestseller", description: "ون مليون - ذهب وإغراء" },
  ...
  { name: "Interlude", brand: "Amouage", category: "رجالي", image: "https://images.unsplash.com/photo-1679944680746-254cbde0ff4a?w=400&h=400&fit=crop", sizes: [{size: "100ml", price: 400},{size: "50ml", price: 270}], status: "special", description: "إنترلود أموج - عطر شرقي فاخر" }
];
