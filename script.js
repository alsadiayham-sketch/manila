...
var cart = normalizeCartItems(JSON.parse(localStorage.getItem('manila_cart') || '[]'), normalizeProducts(DEFAULT_PRODUCTS));
var deliveryMethod = localStorage.getItem('manila_delivery_method') || 'delivery';
...
function saveCart() {
    localStorage.setItem('manila_cart', JSON.stringify(normalizeCartItems(cart, products.length ? products : normalizeProducts(DEFAULT_PRODUCTS))));
}

function setDeliveryMethod(method) {
    deliveryMethod = method;
    localStorage.setItem('manila_delivery_method', method);
